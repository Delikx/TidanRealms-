...
import kabam.rotmg.messaging.impl.incoming.Damage;
    ...
    public class GameObject extends BasicObject
    {
        ...
        public function showDamageText2(dmg:int, pierced:Boolean):void {
            var value:Number = Math.round(map_.player_.criticalMultiplier_ * 10) / 10;
            var CritMultiplied:Number = map_.player_.criticalMultiplier_;
            var value2 = CritMultiplied.toFixed(2);
            var Amount = (dmg * (CritMultiplied))
            var value3 = Amount.toFixed(0);
            ...
            var _loc7_:String = (_loc3_?"-" + value3 + "! (" +  value2+ "x)" + (_loc4_?" [":""):"") + (_loc4_?String(_loc5_) + (_loc3_?"]":""):"");
            if (pierced) {
                var _loc8_:CharacterStatusText = new CharacterStatusText(this, pierced ? 0xD1c8c8 : 0xFF0000, 1000);
            }
            else {
                var _loc8_:CharacterStatusText = new CharacterStatusText(this,0xC9301F,1000);
            }
        ...
        public function statusTextMod(param1:int, param2:Boolean) : void
        {
            ...
            _loc6_ = !!Parameters.data_.STColor?int(int(Character.green2red(this.hp_ / this.maxHP_ * 100))):int(int(_loc6_));
            var _loc7_:String = (_loc3_?"-" + param1 + (_loc4_?"! (1.00x) [":""):"") + (_loc4_?String(_loc5_) + (_loc3_?"]":""):"");
            if (param2) {
                var _loc8_:CharacterStatusText = new CharacterStatusText(this, param2 ? 0xD1c8c8 : 0xFF0000, 1000);
            }else {
                var _loc8_:CharacterStatusText = new CharacterStatusText(this,_loc6_,1000);
            }
