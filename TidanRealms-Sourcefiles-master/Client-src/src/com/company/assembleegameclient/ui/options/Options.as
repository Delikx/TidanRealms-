...
public class Options extends Sprite {
    ...
    private static function makeDamageCounterLabels():Vector.<StringBuilder> {
        return (new <StringBuilder>[new StaticStringBuilder("2"), new StaticStringBuilder("1"), new StaticStringBuilder("0")]);
    }
    ...
    private function addExperimentalOptions():void {
        ...
        this.addOptionAndPosition(new ChoiceOption("smartProjectiles",makeOnOffLabels(),[true,false],"Projectile Direction","Makes projectiles face the direction they\'re going.",null));
    ...
    private function addMiscOptions():void {
        this.addOptionAndPosition(new ChoiceOption("itemColorText", makeOnOffLabels(), [true, false], "Rarity Color Text", "Toggles the color for item descriptions with rarities higher than UT.", null));
        this.addOptionAndPosition(new ChoiceOption("ItemRarityGlow", makeOnOffLabels(), [true, false], "Show Rarity Glow", "Toggles the item glow based on it's rarity \n[Updates upon entering new world!]", null));
        this.addOptionAndPosition(new ChoiceOption("rarityBackground", makeOnOffLabels(), [true, false], "Show Rarity Border", "Toggles the item rarity border.", null));
        this.addOptionAndPosition(new ChoiceOption("rarityBag", makeOnOffLabels(), [true, false], "Show Rarity Bag", "Toggles the display of bag type next the item", null));
        this.addOptionAndPosition(new ChoiceOption("itemTextOutline", makeOnOffLabels(), [true, false], "Show Text Outline", "Toggles outlines on description, stats, and extras.", null));
        this.addOptionAndPosition(new ChoiceOption("showDmgDone",makeOnOffLabels(),[true,false],"Dmg Dealt","Show the % of bosses HP and % of damage done.",null));
    ...
    private function addGraphicsOptions():void {
        ...
        this.addOptionAndPosition(new ChoiceOption("Super", makeOnOffLabels(), [true, false], "Super Glow", "Turns on Super Glow, (glows only on the outline) - RELOAD GAME", null));
