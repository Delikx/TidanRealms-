...
public class EquipmentToolTip extends ToolTip {
    ...
    public function EquipmentToolTip(_arg1:int, _arg2:Player, _arg3:int, _arg4:String) {
        ...
        this.makeItemPowerText(); //feed power
    }
    ...
    private function makeSpecialList():void {
    ...
    private function makeRestrictionList():void {
        ...
        // swapped specialty and legendary pos. since it looks nice
        ...
        if (this.objectXML.hasOwnProperty("MarbleAssistant")) {
            this.restrictions.push(new Restriction(("Assistant: "), MythicalColor, true));
            this.restrictions.push(new Restriction(("When used, a cultist assistant will aid you in battle healing people around it for 50 health every second for 5 seconds."), MythicalColor, false));
        }
