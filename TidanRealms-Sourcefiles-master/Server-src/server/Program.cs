...
namespace server
{
    class Program
    {
        ...
        internal static Webhook banWebhook = new Webhook("https://discordapp.com/api/webhooks/825846040246353920/EqukeUUJ0D-DRlt4uQC7HU7xoFo4YrpNeJkrajs2Bz_Zp_DL-1d8fMfJgHE0xoAeCdle");
