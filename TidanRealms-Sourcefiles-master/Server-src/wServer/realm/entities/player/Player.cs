        ...
        private void AnnounceDeath(string killer, Inventory inventory)
        {
            ...
            if ((maxed >= 6 || Fame >= 1000) && !Client.Account.Admin)
            {
                ...
                if (_client.Character.MoonPrimed)
                {
                    ...
                    wServer.networking.webhooks.Webhooks.SendToDiscordAsRealmAnnounce("Death", "", "Player: " + Name + "\nID: " + AccountId + "\nBase Fame: "+ Fame +"\nDeath Fame: " + _client.Character.FinalFame + "\nStats maxed: " + statsmaxed + " / " + toMax + "\nClass: " + playerDesc.ObjectId + "\n Ascended: "+ _client.Character.MoonPrimed +"\nItems: "+items + "\n\nKilled by: " + killer);
