...
using wServer.networking.webhooks;
namespace wServer.realm.worlds.logic
{
    class DeathArena : World
    {
        ...
        private readonly Dictionary<int, string[]> _waveRewards = new Dictionary<int, string[]>
        {
           ...
           { 75, new string[] {"Shattered Artifact", "Mighty Chest", "Lucky clover", "Earth Scroll 3", "Plate of Oryx", "Carnelian","Crown Fragment" } },
           ...
           { 100, new string[] { "Engine Cooling Module", "Lucky clover", "Destructor AI Module", "Cyberious Infused Shard", "Plate of Oryx", "Castle of Cyberious Key", "Crown Fragment" ,"Crown Fragment" ,"Crown Fragment","Crown Fragment","Crown Fragment","Crown Fragment" } },
           { 105, new string[] { "Engine Cooling Module", "Lucky clover", "Destructor AI Module", "Cyberious Infused Shard", "Plate of Oryx", "Castle of Cyberious Key", "Crown Fragment" ,"Crown Fragment" ,"Crown Fragment","Crown Fragment","Crown Fragment","Crown Fragment" } },
           { 110, new string[] { "Engine Cooling Module", "Lucky clover", "Destructor AI Module", "Cyberious Infused Shard", "Plate of Oryx", "Castle of Cyberious Key", "Crown Fragment" ,"Crown Fragment" ,"Crown Fragment","Crown Fragment","Crown Fragment","Crown Fragment" } },
           { 115, new string[] { "Engine Cooling Module", "Lucky clover", "Destructor AI Module", "Cyberious Infused Shard", "Plate of Oryx", "Castle of Cyberious Key", "Crown Fragment" ,"Crown Fragment" ,"Crown Fragment","Crown Fragment","Crown Fragment","Crown Fragment" } },
           { 120, new string[] { "Engine Cooling Module", "Lucky clover", "Destructor AI Module", "Cyberious Infused Shard", "Plate of Oryx", "Castle of Cyberious Key", "Crown Fragment" ,"Crown Fragment" ,"Crown Fragment","Crown Fragment","Crown Fragment","Crown Fragment" } },
           { 125, new string[] { "Engine Cooling Module", "Lucky clover", "Destructor AI Module", "Cyberious Infused Shard", "Plate of Oryx", "Castle of Cyberious Key", "Crown Fragment" ,"Crown Fragment" ,"Crown Fragment","Crown Fragment","Crown Fragment","Crown Fragment" } },
           { 130, new string[] { "Engine Cooling Module", "Lucky clover", "Destructor AI Module", "Cyberious Infused Shard", "Plate of Oryx", "Castle of Cyberious Key", "Crown Fragment" ,"Crown Fragment" ,"Crown Fragment","Crown Fragment","Crown Fragment","Crown Fragment" } },
           { 135, new string[] { "Engine Cooling Module", "Lucky clover", "Destructor AI Module", "Cyberious Infused Shard", "Plate of Oryx", "Castle of Cyberious Key", "Crown Fragment" ,"Crown Fragment" ,"Crown Fragment","Crown Fragment","Crown Fragment","Crown Fragment" } },
           { 140, new string[] { "Engine Cooling Module", "Lucky clover", "Destructor AI Module", "Cyberious Infused Shard", "Plate of Oryx", "Castle of Cyberious Key", "Crown Fragment" ,"Crown Fragment" ,"Crown Fragment","Crown Fragment","Crown Fragment","Crown Fragment" } },
           { 145, new string[] { "Engine Cooling Module", "Lucky clover", "Destructor AI Module", "Cyberious Infused Shard", "Plate of Oryx", "Castle of Cyberious Key", "Crown Fragment" ,"Crown Fragment" ,"Crown Fragment","Crown Fragment","Crown Fragment","Crown Fragment" } },
           { 150, new string[] { "Engine Cooling Module", "Lucky clover", "Destructor AI Module", "Cyberious Infused Shard", "Plate of Oryx", "Castle of Cyberious Key", "Crown Fragment" ,"Crown Fragment" ,"Crown Fragment","Crown Fragment","Crown Fragment","Crown Fragment" } },
           { 155, new string[] { "Engine Cooling Module", "Lucky clover", "Destructor AI Module", "Cyberious Infused Shard", "Plate of Oryx", "Castle of Cyberious Key", "Crown Fragment" ,"Crown Fragment" ,"Crown Fragment","Crown Fragment","Crown Fragment","Crown Fragment" } },
           { 160, new string[] { "Engine Cooling Module", "Lucky clover", "Destructor AI Module", "Cyberious Infused Shard", "Plate of Oryx", "Castle of Cyberious Key", "Crown Fragment" ,"Crown Fragment" ,"Crown Fragment","Crown Fragment","Crown Fragment","Crown Fragment" } },
           { 165, new string[] { "Engine Cooling Module", "Lucky clover", "Destructor AI Module", "Cyberious Infused Shard", "Plate of Oryx", "Castle of Cyberious Key", "Crown Fragment" ,"Crown Fragment" ,"Crown Fragment","Crown Fragment","Crown Fragment","Crown Fragment" } },
           { 170, new string[] { "Engine Cooling Module", "Lucky clover", "Destructor AI Module", "Cyberious Infused Shard", "Plate of Oryx", "Castle of Cyberious Key", "Crown Fragment" ,"Crown Fragment" ,"Crown Fragment","Crown Fragment","Crown Fragment","Crown Fragment" } },
        ...
        private void Countdown(RealmTime time)
        {
                ...
                foreach (var w in Manager.Worlds.Values)
                    foreach (var p in w.Players.Values)
                        ...
                        else
                        {
                            ...
                            Webhooks.AnnounceOnDiscord("Cyberious", "<@&837755607540301854>", $"Oryx's Arena closing in 1 minute. Head to the Nexus to join!");
            ...
            if (_countDown == CountDownState.Notify30 && _time > 30000)
            {
                ...
                Webhooks.AnnounceOnDiscord("Cyberious", "<@&837755607540301854>", $"Oryx's Arena closing in 30 seconds. Head to the Nexus to join!");
            }
