      ...
      .Init("Zhin, The Demonic Sacrifice",
            ...
            new Threshold(0.01,
                   new ItemLoot("Staff of Unholy Sacrifice", 0.004, damagebased: true, threshold: 0.01),
                    ...
                    new ItemLoot("Potion of Critical Chance", 2),
            ...
            new State(
              ...
              new State("fight",
               ...
               new Threshold(0.1,
                    ...
                    new ItemLoot("Minir's Robe of the Cultist", 0.001, damagebased: true)
            )
          )
            ...
            new State(
              ...
              new State("fight",
                ...
                new Shoot(180, count: 2, projectileIndex: 2, shootAngle: 10, coolDown: 1400)
                 ...
                 new Threshold(0.1,
                    new ItemLoot("Mark of Rave Darkmore", 0.001),
                    new ItemLoot("Bige's Robe of the Cultist", 0.001, damagebased: true)
            )
            ...
            new State(
              ...
              new State("fight",
                ...
                new Shoot(25, count: 5, projectileIndex: 0, shootAngle: 10, coolDown: 750)
                  ...
                  new Threshold(0.1,
                    new ItemLoot("Mark of Rave Darkmore", 0.001),
                    new ItemLoot("Palow's Robe of the Cultist", 0.001, damagebased: true)
            )
          )
          .Init("Balo, Follower of the Zahari",
            new State(
              ...
              new State("fight",
                ...
                new Threshold(0.1,
                    new ItemLoot("Mark of Rave Darkmore", 0.001),
                    new ItemLoot("Balo's Robe of the Cultist", 0.001, damagebased: true)
            )
          )
