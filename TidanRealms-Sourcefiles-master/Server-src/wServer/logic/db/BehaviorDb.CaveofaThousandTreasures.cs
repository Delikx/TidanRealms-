        ...
        private _ CaveofaThousandTreasures = () => Behav()
            .Init("Golden Oryx Effigy",
                ...
                new Threshold(0.0001,
                    ...
                    new ItemLoot("Mighty Chest", 0.03),
                    new ItemLoot("Standard Chest", 0.10),
                    new ItemLoot("Mark of the Effigy", 0.10),
                    new ItemLoot("Mark of the Effigy", 0.25),
                    new ItemLoot("Mark of the Effigy", 1),
