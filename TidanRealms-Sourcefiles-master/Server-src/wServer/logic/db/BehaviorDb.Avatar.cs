        ...
        private _ Avatar = () => Behav()
            .Init("shtrs Defense System", //Avatar of the Forgotten King 
                ...
                new Threshold(0.0001,
                    ...
                    new ItemLoot("Potion of Defense", .3, 2),
                    new ItemLoot("Potion of Attack", .3, 2),
                    new ItemLoot("Potion of Vitality", .3, 2),
                    new ItemLoot("Potion of Wisdom", .3, 2),
                    new ItemLoot("Potion of Speed", .3, 2),
                    new ItemLoot("Potion of Dexterity", .3, 2),
